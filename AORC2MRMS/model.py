...
class Generator(nn.Module):
    def __init__(self, filter_size: int = 16):
        super().__init__()
...
class Discriminator(nn.Module):
    def __init__(self, filter_size: int = 32):
        ...
        self.conv1 = ResidualBlock3D(1, f, use_layer_norm=False, stride=(2,1,1), )
        ...
        self.conv4 = ResidualBlock3D(f, f, use_layer_norm=True, stride=(1,5,5), )
