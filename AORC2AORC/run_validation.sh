...
do
  ...
  python -u validation.py \
    ...
    --end_year 2014 \
    --cotinuous_year 5\
    --input_source "/scratch/jl14811/GCM_2012-2014/${model}" \
    --target_source "/scratch/jl14811/AORC_2012-2014/AORC_126_186" \
...
do
  ...
  python -u validation.py \
    ...
    --end_year 2014 \
    --cotinuous_year 5\
    --input_source "/scratch/jl14811/AORC_2012-2014/${model}" \
    --target_source "/scratch/jl14811/AORC_2012-2014/AORC_126_186" \
    --model_path model_weights/models_aorc_aorc_1-3.pth \
    --step 3 \
    --validation_file "validation/1_3_3-train/${model}" \
